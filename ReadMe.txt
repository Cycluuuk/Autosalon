Данная программа является базой данной для Автосервиса.
Программа написана на C#, а база данных MySql 2008.
Весь код программы представлен в файле Program code.
А за все запросы записанный в файле requests.
SQL Скрипт для создания базы данных Проекта на MySQL
